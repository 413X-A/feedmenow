...
function felder_faerben() {
    ...
    const pflanze = Object.values(daten.pflanzenDaten)
...
function feld_angeklickt(daten, pflanze, feld_nummer) {
    ...
    // --------------------
    if (feldObjekt.status === "bepflanzt") {
        const pflanzeDaten = daten.pflanzenDaten[feldObjekt.pflanze];
        ...
        if (Date.now() < feldObjekt.zeit_gewachsen) {
            ...
            if (daten.ressourcen.anz_pflanzen < daten.lagerplatz.pflanzen) {
                ...
                if (daten.einstellungen.effekte) {
                    const purchaseSound = new Audio("geerntet_normale.mp3");
                ...
                daten.benutzer_explevel = (daten.benutzer_explevel || 0) + pflanzeDaten.xp;
                ...
                ressDialog.innerHTML = `
                    ...
                    <p>Du hast keinen Lagerplatz frei, um diese Pflanze zu ernten.</p>
                `;
    ...
    // --------------------
    const aktuellePflanzen = Object.values(daten.pflanzenDaten).filter(p => {
    ...
    setzenButton.addEventListener('click', () => {
        ...
        if (daten.ressourcen.wasser >= ausgewähltePflanze.wasserverbrauch &&
            ...
            // Sound Effekt
            if (daten.einstellungen.effekte) {
                const purchaseSound = new Audio("gepflanzt_normale.mp3");
            ...
            if (daten.ressourcen.wasser < ausgewähltePflanze.wasserverbrauch &&
                ...
                ressDialog.innerHTML = `
                    ...
                    <p>Du hast weder genug Wasser noch Energie, um diese Pflanze zu setzen.</p>
                `;
